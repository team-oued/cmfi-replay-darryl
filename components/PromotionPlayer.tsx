...
const PromotionPlayer: React.FC<PromotionPlayerProps> = ({ onPromotionEnd, onSkip }) => {
    ...
    const loadAd = async () => {
      try {
        ...
        if (!settings || !settings.enabled) {
          ...
          setLoading(false);
          onPromotionEnd(); // Pas de pub, passer directement à la vidéo
          return;
        }
        ...
        if (!randomAd) {
          ...
          setLoading(false);
          onPromotionEnd(); // Pas de pub disponible, passer directement à la vidéo
          return;
        }
