...
import { continueWatching, popularSeries, newMovies, featuredPodcasts, featuredContent, mostWatched, mostLiked, history } from '../data/mockData';
...
const NavigationTiles: React.FC<{ navigateToCategory: (type: MediaType) => void }> = ({ navigateToCategory }) => {
  ...
  const categories = [
    ...
    { titleKey: 'categoryMovies', imageUrl: 'https://picsum.photos/seed/docs-tile/400/300', type: MediaType.Movie },
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        <MediaRow title={t('newMovies')} items={newMovies} onSelectMedia={onSelectMedia} onPlay={onPlay} />
